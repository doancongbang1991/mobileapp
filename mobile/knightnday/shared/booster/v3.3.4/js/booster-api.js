            ...
            var a = new r,
                ...
                l = n.View.extend({
                    ...
                    initialize: function(t) {
                        t.orientation != undefined && (this.orientation = t.orientation), t.minimalUI != undefined && (this.minimalUI = t.minimalUI), t.rotationImage != undefined && (this.rotationImage = t.rotationImage), this.minimalUI && e(window).on("resize", function() {
                            window.scrollTo(0, 1)
                    ...
                    render: function(n, r) {
                        ...
                        }), e("body").append(l), f && this.rotationImage != "rotate.png" && (a.changeRotationImage(this.rotationImage, n), e("#rotation-text").remove())
                    }
                });
            return l
                ...
                h = n.View.extend({
                    ...
                    initialize: function(e) {
                        ...
                        pm.bind("iframeClose", function(e) {
                            ...
                            window.onTimerPassed(), n._close()
                        }), pm.bind("callbackUserCloseAd", function(e) {
                            window.onAdSkip(), n._close()
                        }), pm.bind("callbackUserClickAd", function(e) {
                            window.onAdClick()
                        });
                        var r = document.createElement("script");
                        r.src = "./ima3.js", document.body.appendChild(r), r.onload = function() {
                    ...
                    render: function() {
                        ...
                        })) : this.mode === "BUILTIN" && (c.setMessage("Advertisement shown without bm.source & bm.gameid present in the url"), o = t.template(i, {})), e("body").append(o)
                    },
