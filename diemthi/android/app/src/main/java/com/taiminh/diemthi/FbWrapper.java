...
import com.taiminh.diemthi.activity.BaseFacebookWebViewActivity;
import com.taiminh.diemthi.preferences.FacebookPreferences;
...
public class FbWrapper extends BaseFacebookWebViewActivity {
    ...
    private void setOnClickListeners() {
        ...
        findViewById(R.id.menu_item_moreapp).setOnClickListener(buttonsListener);

        findViewById(R.id.menu_item_vnexpress).setOnClickListener(buttonsListener);
        findViewById(R.id.menu_item_hcm).setOnClickListener(buttonsListener);
        findViewById(R.id.menu_item_giaoduc).setOnClickListener(buttonsListener);
        findViewById(R.id.menu_item_thisinh).setOnClickListener(buttonsListener);
     ...
     * Most preferences will be automatically set for the {@link com.taiminh.firebrigade.webview.FacebookWebView}.
     */
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                ...
                case R.id.menu_item_refresh:
                    refreshCurrentPage();
                    break;
                case R.id.menu_item_moreapp:
                    loadNewPage(url_moreapp);
                    break;
                case R.id.menu_item_vnexpress:
                    loadNewPage(url_vnexpress);
                    break;
                case R.id.menu_item_hcm:
                    loadNewPage(url_hcm);
                    break;
                case R.id.menu_item_thisinh:
                    loadNewPage(url_thisinh);
                    break;
                case R.id.menu_item_giaoduc:
                    loadNewPage(url_giaoduc);
                    break;
