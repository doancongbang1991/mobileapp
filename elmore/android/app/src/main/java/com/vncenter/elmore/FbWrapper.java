...
import com.vncenter.elmore.activity.BaseFacebookWebViewActivity;
import com.vncenter.elmore.preferences.FacebookPreferences;
...
public class FbWrapper extends BaseFacebookWebViewActivity {
    ...
    private void loadPreferences() {
        ...
        boolean anyDomain = mSharedPreferences.getBoolean(FacebookPreferences.OPEN_LINKS_INSIDE, true);
