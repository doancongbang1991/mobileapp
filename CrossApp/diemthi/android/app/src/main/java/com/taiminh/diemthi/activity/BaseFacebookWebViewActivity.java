...
package com.taiminh.diemthi.activity;
...
import com.taiminh.diemthi.R;
import com.taiminh.diemthi.util.Logger;
import com.taiminh.diemthi.util.OrbotHelper;
import com.taiminh.diemthi.util.WebViewProxyUtil;
import com.taiminh.diemthi.webview.FacebookWebChromeClient;
import com.taiminh.diemthi.webview.FacebookWebView;
import com.taiminh.diemthi.webview.FacebookWebViewClient;
...
public abstract class BaseFacebookWebViewActivity extends Activity implements
    ...
    //URL HTML file offline
    //protected final static String url_game = "file:///android_asset/www/index.html";
    protected  final static String url_vnexpress = "http://diemthi.vnexpress.net/";
    protected  final static String url_hcm = "http://tracuudiem.hcmute.edu.vn/";
    protected  final static String url_thisinh = "https://thisinh.thithptquocgia.edu.vn/Account/Login?ReturnUrl=%2f";
    protected  final static String url_giaoduc = "http://giaoduc.net.vn/diemthi.aspx";
    //URL TM Apps;
    protected final static String url_moreapp = "http://www.taiminh.com/blog/our-mobile-apps/";
    ...
    public void onCreate(Bundle savedInstanceState) {
        StartAppSDK.init(this, "206405485", true);
        ...
        StartAppAd.showSplash(this, savedInstanceState,
                new SplashConfig()
                        ...
                        .setLogo(R.drawable.fireman)   // resource ID
