...
mit.main = function() {
  ...
  */
  ...
  tweet.href='http://twitter.com/share?url=http://www.taiminh.com/&text=I am playing Pappu Pakia, a cute HTML5 game on TM Apps!';

  var facebook = document.getElementById("fb");
  facebook.href='http://facebook.com/sharer.php?s=100&p[url]=http://www.taiminh.com/&p[title]=I am playing Pappu Pakia, a cute HTML5 game on TM Apps!';
  ...
  */
  mit.gameOver = function() {
    ...
    // Share
    var tweet = document.getElementById("tweet");
    tweet.href='http://twitter.com/share?url=http://mobile.taiminh.com/&text=I just scored ' +Math.floor(mit.score)+ ' points in Pappu Pakia!&count=horiztonal&via=_rishabhp&related=solitarydesigns';
  
    var facebook = document.getElementById("fb");
    facebook.href='http://facebook.com/sharer.php?s=100&p[url]=http://mobile.taiminh.com/&p[title]=I just scored ' +Math.floor(mit.score)+ ' points in the Pappu Pakia!';
